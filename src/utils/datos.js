module.exports = [
  {
    ...
    genre: [
      "Fiction",
      "Drama", // Additional genre 1
      "Legal thriller", // Additional genre 2
    ],
    book_description:
  ...
  },
  {
    ...
    book_description:
      "In a dystopian future, Katniss Everdeen volunteers to take her sister's place in the Hunger Games, a televised competition where teenagers fight to the death in a post-apocalyptic world.",
    price: 12.99,
    editorial: "Scholastic Press",
    year_of_edition: 2008,
    language: "English",
    age_segment: "Adulto",
  },
  {
    ...
    book_description:
      "In the 1930s, Jacob Jankowski, a veterinary student, joins the Benzini Brothers Circus as their resident vet, where he falls in love with Marlena, the beautiful equestrian star, and befriends Rosie, the captivating elephant.",
    price: 12.99,
    editorial: "Doubleday",
    year_of_edition: 2003,
    language: "English",
    age_segment: "Adulto",
  },
  {
    ...
    genre: ["Fiction", "Historical Fiction", "Political Thriller"],
    book_description:
  ...
  },
  {
    ...
    genre: ["Drama", "Historical Drama", "Spanish Literature"],
    book_description:
      "En Fuenteovejuna las sabias combinaciones rítmicas dan una ágil eficiencia a los planteamientos dramáticos; con la hechura de los personajes, sesgada pero nítida. y el clímax del conflicto hacen de esta pieza una de las cimas del arte escénico.",
    price: 10.0,
    editorial: "El Lector",
    year_of_edition: 2010,
    language: "Spanish",
    age_segment: "Adulto",
  },
  {
    ...
    book_description:
      'Ficciones es quizá el libro más famoso de Jorge Luis Borges. En él se encuentran algunos de sus cuentos más conocidos, como "Tlön, Uqbar, Orbis Tertius", "Pierre Menard, autor del Quijote", "Funes el memorioso", "La lotería en Babilonia", "El jardín de los senderos que se bifurcan" o "La biblioteca de Babel".',
    price: 15.99,
    editorial: "Debolsillo",
    year_of_edition: 2011,
    language: "Spanish",
    age_segment: "Adulto",
  },
  {
...

  {
    ...
    book_description:
      "A través de su viaje por el mundo de los «fuera de serie», los mejores, los más brillantes y famosos, nos convence de que nuestro modo de pensar en el éxito es erróneo.Prestamos demasiada atención al aspecto de estas personas, y muy poca al lugar de donde vienen, es decir, a su cultura, su familia, su generación y las singularidades de su educación. Brillante y entretenido, Fuera de serie es toda una referencia que al mismo tiempo iluminará y hará disfrutar.",
    price: 10.0,
    editorial: "Debolsillo",
    year_of_edition: 2004,
    language: "Spanish",
    age_segment: "Adulto",
  },
  {
  ...
  },
  {
    ...
    genre: ["Fiction", "Inspirational", "Adventure"],
    book_description:
  ...
  },
  {
    ...
    book_description:
      "Orphaned Jane Eyre grows up in the home of her heartless aunt, where she endures loneliness and cruelty, and at a charity school with a harsh regime. This troubled childhood strengthens Jane's natural independence and spirit—which prove necessary when she goes to work as a governess at Thornfield Hall.",
    price: 12.99,
    editorial: "Penguin Classics",
    year_of_edition: 1997,
    language: "English",
    age_segment: "Adulto",
  },
  {
  ...
  },
  {
    ...
    book_description:
      "The story of the voyage of the whaling ship Pequod, commanded by Captain Ahab, who leads his crew on a hunt for the great whale Moby Dick, driven by his obsession to extract revenge on the creature that destroyed his last ship and left him crippled.",
    price: 13.99,
    editorial: "Penguin Classics",
    year_of_edition: 2003,
    language: "English",
  ...
  },
  {
    ...
    price: 5.99,
    editorial: "Grapevine India",
    year_of_edition: 2022,
    language: "English",
    age_segment: "Juvenil",
  },
  {
